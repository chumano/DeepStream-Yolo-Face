` gst-inspect-1.0 > GST_FACTORIES.md `
...
libav:  avdec_acelp_kelvin: libav Sipro ACELP.KELVIN decoder
...
libav:  avdec_adpcm_argo: libav ADPCM Argonaut Games decoder
...
libav:  avdec_adpcm_ima_alp: libav ADPCM IMA High Voltage Software ALP decoder
libav:  avdec_adpcm_ima_amv: libav ADPCM IMA AMV decoder
libav:  avdec_adpcm_ima_apc: libav ADPCM IMA CRYO APC decoder
libav:  avdec_adpcm_ima_apm: libav ADPCM IMA Ubisoft APM decoder
libav:  avdec_adpcm_ima_cunning: libav ADPCM IMA Cunning Developments decoder
...
libav:  avdec_adpcm_ima_moflex: libav ADPCM IMA MobiClip MOFLEX decoder
libav:  avdec_adpcm_ima_mtf: libav ADPCM IMA Capcom's MT Framework decoder
...
libav:  avdec_adpcm_ima_ssi: libav ADPCM IMA Simon & Schuster Interactive decoder
...
libav:  avdec_adpcm_zork: libav ADPCM Zork decoder
...
libav:  avdec_argo: libav Argonaut Games Video decoder
...
libav:  avdec_av1: libav Alliance for Open Media AV1 decoder
...
libav:  avdec_cfhd: libav GoPro CineForm HD decoder
...
libav:  avdec_cri: libav Cintel RAW decoder
...
libav:  avdec_derf_dpcm: libav DPCM Xilam DERF decoder
...
libav:  avdec_fastaudio: libav MobiClip FastAudio decoder
...
libav:  avdec_hca: libav CRI HCA decoder
...
libav:  avdec_imm5: libav Infinity IMM5 decoder
...
libav:  avdec_ipu: libav IPU Video decoder
...
libav:  avdec_mobiclip: libav MobiClip Video decoder
...
libav:  avdec_msp2: libav Microsoft Paint (MSP) version 2 decoder
...
libav:  avdec_mv30: libav MidiVid 3.0 decoder
...
libav:  avdec_mvdv: libav MidiVid VQ decoder
libav:  avdec_mvha: libav MidiVid Archive Codec decoder
...
libav:  avdec_notchlc: libav NotchLC decoder
...
libav:  avdec_pgx: libav PGX (JPEG2000 Test Format) decoder
libav:  avdec_photocd: libav Kodak Photo CD decoder
...
libav:  avdec_prores: libav Apple ProRes (iCodec Pro) decoder
...
libav:  avdec_sga: libav Digital Pictures SGA Video decoder
...
libav:  avdec_siren: libav Siren decoder
...
libav:  avdemux_xwma: libav Microsoft xWMA demuxer
...
libav:  avenc_adpcm_argo: libav ADPCM Argonaut Games encoder
libav:  avenc_adpcm_ima_alp: libav ADPCM IMA High Voltage Software ALP encoder
libav:  avenc_adpcm_ima_amv: libav ADPCM IMA AMV encoder
libav:  avenc_adpcm_ima_apm: libav ADPCM IMA Ubisoft APM encoder
libav:  avenc_adpcm_ima_qt: libav ADPCM IMA QuickTime encoder
libav:  avenc_adpcm_ima_ssi: libav ADPCM IMA Simon & Schuster Interactive encoder
...
libav:  avenc_exr: libav OpenEXR image encoder
...
libav:  avenc_pfm: libav PFM (Portable FloatMap) image encoder
...
libav:  avmux_alp: libav LEGO Racers ALP muxer
libav:  avmux_amr: libav 3GPP AMR muxer
libav:  avmux_amv: libav AMV muxer
libav:  avmux_apm: libav Ubisoft Rayman 2 APM muxer
libav:  avmux_apng: libav Animated Portable Network Graphics muxer
libav:  avmux_argo_asf: libav Argonaut Games ASF muxer
...
libav:  avmux_kvag: libav Simon & Schuster Interactive VAG muxer
...
libav:  avmux_streamhash: libav Per-stream hash testing muxer
...
libav: avtype_xwma: no extensions
...
qmlgl:  qmlgloverlay: Qt Video Overlay
qmlgl:  qmlglsink: Qt Video Sink
qmlgl:  qmlglsrc: Qt Video Source
...
Total count: 260 plugins (1 blacklist entry not shown), 1550 features
